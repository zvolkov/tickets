...
{
    //from http://aspnet.codeplex.com/SourceControl/latest#Samples/WebApi/Elmah/Elmah.Server/ExceptionHandling/ElmahExceptionLogger.cs
    public class LogWebApiExceptionsToElmah : ExceptionLogger
    {
